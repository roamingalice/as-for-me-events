...
CARDS = [
    {
        ...
        "rules": ["限 ASify 敦化店結帳當日使用。", "結帳時抽一張花卡，當場掃 QR code 確認內容。", "限定正價商品，不可與其他優惠併用。", "贈品數量有限，送完為止。", "店員以現場抽到的實體花卡與手機頁面確認。"],
    ...
    },
    {
        ...
        "rules": ["限 ASify 敦化店結帳當日使用。", "結帳時抽一張花卡，當場掃 QR code 確認內容。", "限定正價商品，不可與其他優惠併用。", "此贈品為花卡加碼；原門市滿額贈規則照常依現場公告。", "贈品數量有限，送完為止。", "店員以現場抽到的實體花卡與手機頁面確認。"],
    ...
    },
    {
        ...
        "rules": ["限 ASify 敦化店結帳當日使用。", "結帳時抽一張花卡，當場掃 QR code 確認內容。", "限定正價商品，不可與其他優惠併用。", "店員以現場抽到的實體花卡與手機頁面確認。"],
    ...
    },
    {
        ...
        "rules": ["限 ASify 敦化店結帳當日使用。", "結帳時抽一張花卡，當場掃 QR code 確認內容。", "消費一個正價商品即贈 Hebe Bratop 橘色。", "不可與其他優惠併用。", "尺寸與數量依現場庫存為準，送完為止。", "店員以現場抽到的實體花卡與手機頁面確認。"],
    ...
    },
    {
        ...
        "rules": ["限 ASify 敦化店結帳當日使用。", "結帳時抽一張花卡，當場掃 QR code 確認內容。", "限定正價商品，不可與其他優惠併用。", "任選商品買二送一，依價高者計算。", "店員以現場抽到的實體花卡與手機頁面確認。"],
